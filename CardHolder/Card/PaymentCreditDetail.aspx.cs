...
namespace CardHolder
{
    ...
    public partial class PaymentCreditDetail : PageBase
    {
        ...
        public List<CH_Cr_Current_Trans> lst = new List<CH_Cr_Current_Trans>();
        ...
        private void BindData()
        {
            ...
            {
                string strfromDate = DateTime.Now.AddMonths(-6).ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
        ...
        private void BindPaymentCreditDetail(string accountNumber, DateTime? FromDate, DateTime? Todate)
        {
            ...
            if (lst != null && lst.Count > 0)
            {
                ...
                {
                    string Months = item.Transaction_Date.Month.ToString();
                    string Years = item.Transaction_Date.Year.ToString();
                    switch (Months)
                    {
                        case "1":
                         Month = "January";
