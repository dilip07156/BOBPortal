...
namespace CardHolder.Utility
{
    public static class UrlHelper
    {
        ...
        private static String PlaceOne(String Number)
        {
        ...
        private static String PlaceTwo(String Number)
        {
            int _Number = Convert.ToInt32(Number);
            String name = null;
            switch (_Number)
            {
                ...
                default:
                    if (_Number > 0)
                    {
                        name = PlaceTwo(Number.Substring(0, 1) + "0") + " " + PlaceOne(Number.Substring(1));
                    }
                    break;
            }
            return name;
                ...
                {//test for zero or digit zero in a nuemric    
                    ...
                    switch (numDigits)
                    {
                        case 1://ones' range    
                            ...
                            word = PlaceOne(Number);
                            isDone = true;
                            break;
                        case 2://tens' range    
                            word = PlaceTwo(Number);
                            isDone = true;
                            break;
